...
<head>
    ...
    <title>Peran dan Partisipasi Mahasiswa dalam Kemajuan Literasi Masyarakat</title>
    <style>
        body {
        ...
        .container {
            ...
            margin: 40px auto;
            padding: 40px;
            box-shadow: 0 4px 12px rgba(90, 70, 52, 0.15);
            border-radius: 12px;
        ...
        /* Tambahan sentuhan earthy di hr */
        hr {
            border: none;
            height: 2px;
            background: #d2c2b0;
...
<div class="container">
    ...
    <h2>Pendidik Informal di Tengah Masyarakat</h2>
